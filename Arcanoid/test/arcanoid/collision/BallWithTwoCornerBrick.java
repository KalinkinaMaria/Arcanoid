 ...
 * @author Елена
 */
public class BallWithTwoCornerBrick extends Game implements CollisionHandleEndListener {
    /** Игровое поле */
     ...
     * @param table Буфер
     */
    public BallWithTwoCornerBrick (Buffer table) {
        this.table = table;
    }
    ...
    public void initResources() {
        ...
        Sprite brick1 = new Sprite(brickImage, 320, 500);
        Sprite brick2 = new Sprite(brickImage, 400, 470);
        //Заполняем буфер
