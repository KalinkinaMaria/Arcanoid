 ...
 * @author Елена
 */
public class BallWithBrick extends Game implements CollisionHandleEndListener {
    /** Игровое поле */
     ...
     * @param table Буфер
     */
    public BallWithBrick (Buffer table) {
        this.table = table;
    }
    ...
    public void initResources() {
        ...
        Sprite brick = new Sprite(brickImage, 360, 470);
        //Заполняем буфер
