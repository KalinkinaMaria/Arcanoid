 ...
 * @author Елена
 */
public class BallWithSideBrick extends Game implements CollisionHandleEndListener {
    /** Игровое поле */
     ...
     * @param table Буфер
     */
    public BallWithSideBrick (Buffer table) {
        this.table = table;
    }
    ...
    public void initResources() {
        ...
        Sprite brick = new Sprite(brickImage, 320, 500);
        //Заполняем буфер
